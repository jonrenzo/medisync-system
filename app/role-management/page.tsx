...
import {AlertCircle, Edit, Trash2, UserPlus, Loader2, ShieldAlert} from "lucide-react"
...
export default function UserManagement() {
                        ...
                        <CardContent className="pt-6">
                            <div className="flex flex-col items-center justify-center py-12 text-center">
                                ...
                                <p className="text-muted-foreground max-w-md mb-6">
                                    ...
                                    Please contact your system administrator if you need access to this page.
                                </p>
    ...
    return (
        <ProtectedPage pageName="UserManagement">
            <div className="min-h-screen bg-background p-6">
                        ...
                        <Dialog open={isAddUserOpen} onOpenChange={setIsAddUserOpen}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>Create a new user account with role
