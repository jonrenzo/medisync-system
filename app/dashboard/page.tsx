        ...
        <ProtectedPage pageName={"Dashboard"}>
            <div className="min-h-screen p-6 space-y-6 bg-background font-lexend">
                ...
                <div className="grid grid-cols-2 gap-6 md:grid-cols-2">
                    ...
                    <Card className="bg-white">
                        <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                            <CardTitle className="text-sm font-medium text-dark">Total Medicines in Low
                                Stocks</CardTitle>
                    ...
                    <Card className="bg-white">
                        <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                            <CardTitle className="text-sm font-medium text-dark">Total Medicines in High
                                Stocks</CardTitle>
                                ...
                                <div className="space-y-4">
                                    {lowStockMedicines.map((medicine, index) => (
                                        <div key={index}
                                            ...
                                            <Badge
                                                variant={medicine.status === "critical" ? "destructive" : "secondary"}>
