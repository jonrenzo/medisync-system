        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="overflow-y-auto max-h-[90vh] sm:max-w-2xl">
                ...
                <div className="grid grid-cols-2 gap-4 py-4">
                    ...
                    {/* Item Code (QR Code) */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700">Item Code (QR Code)</label>
                        <Input
                            name="medicine_code"
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            disabled={isSaving}
                        />
                        <p className="mt-1 text-xs text-gray-500">Dosage and unit type will auto-fill</p>
                    </div>
                    ...
                    {/* Unit of Measurement */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700">Unit of Measurement</label>
                        <Input
                            name="unit_type"
                    ...
                    {/* Purchase Month */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700">Purchase Month</label>
                        <Input
                            name="purchase_month"
                    ...
                    {/* Purchase Year */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700">Purchase Year</label>
                        <Input
                            name="purchase_year"
                    ...
                    {/* Purchase Order No. */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700">Purchase Order No.</label>
                        <Input
                    ...
                    {/* Batch/Lot No. */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700">Batch/Lot No.</label>
                        <Input
                            name="batch_lot_no"
                    ...
                    {/* Quantity Requested */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700">Quantity Requested</label>
                        <Input
                    ...
                    {/* Stocks Available */}
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700">Stocks Available</label>
                        <Input
                            name="ending_balance"
                            type="number"
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            disabled={true}
                        />
                        <p className="mt-1 text-xs text-gray-500">Auto-calculated: Unit Cost × Stocks Available</p>
                    </div>
                </div>
                ...
                <div className="flex justify-end gap-3 border-t border-gray-200 pt-4">
                    <Button
                        ...
                        className="border-gray-300 bg-transparent text-foreground hover:bg-gray-50"
                        disabled={isSaving}
                    >
                        Cancel
                    </Button>
